        ...
        <div id="article" class="col-md-12">
            <main id="primary" class="site-main">
                <div id="maincol" class="row">
                    <div class="col-md-6">
                        <div class="inseid">
                            <button id="juslikeme" onclick="goBack()" class="btn btn-primary">Retour à la page
                                précédente</button>
                        ...
                        <div id="postsidebar">
                            <div class="content">
                                ...
                                <div id="theacolyte">
                                    ...
                                    <a id="bbenchwap" href="<?php echo get_permalink('304'); ?>">Mon espace candidat</a>
                                    <a href="<?php echo get_permalink('119');?>">Offres d'emploi</a>
                                    <a href="<?php echo wp_logout_url(home_url()); ?>">Déconnexion</a>
                                    <?php else : ?>
                                    <a href="https://bigfive.dev/demobralico/pole-emploi/"
                                        class="create-account-button">Créer
                                        un compte</a>
                                    <?php endif; ?>
